...
class Config(StrictDataClass):
    ...
    debug_timing : bool
        Whether to log stage-level timing heartbeats during data generation, training, validation, and checkpointing.
    slow_stage_seconds : float
        Stages slower than this threshold are logged even when debug_timing is disabled.
    log_generated_objs : bool
        Whether to write generated objects to SQLite files under the run directory.
    ...
    slow_stage_seconds: float = 60.0
    log_generated_objs: bool = True
