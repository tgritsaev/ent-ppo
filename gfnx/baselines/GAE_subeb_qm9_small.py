"""Single-file implementation for SUBEB-GAE in QM9Small environment.

Run the script with the following command:
```bash
python baselines/GAE_subeb_qm9_small.py
```
...
@hydra.main(config_path="configs/", config_name="GAE_subeb_qm9_small", version_base=None)
